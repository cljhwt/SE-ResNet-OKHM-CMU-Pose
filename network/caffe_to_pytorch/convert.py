...
import sys
sys.path.append('/home/wangcl/wangcl/caffe/python')
...
for i in range(2,7):
    blocks['block%d_1'%i]  = [{'Mconv1_stage%d_L1'%i:[185,128,3,1,1]},{'Mconv2_stage%d_L1'%i:[128,128,3,1,1]},{'Mconv3_stage%d_L1'%i:[128,128,3,1,1]},{'Mconv4_stage%d_L1'%i:[128,128,3,1,1]},
{'Mconv5_stage%d_L1'%i:[128,128,3,1,1]},{'Mconv6_stage%d_L1'%i:[128,128,1,1,0]},{'Mconv7_stage%d_L1'%i:[128,38,1,1,0]}]
    blocks['block%d_2'%i]  = [{'Mconv1_stage%d_L2'%i:[185,128,3,1,1]},{'Mconv2_stage%d_L2'%i:[128,128,3,1,1]},{'Mconv3_stage%d_L2'%i:[128,128,3,1,1]},{'Mconv4_stage%d_L2'%i:[128,128,3,1,1]},
{'Mconv5_stage%d_L2'%i:[128,128,3,1,1]},{'Mconv6_stage%d_L2'%i:[128,128,1,1,0]},{'Mconv7_stage%d_L2'%i:[128,19,1,1,0]}]
...
#
#     print('image', imageToTest_padded.shape[0])
#     print('image_a', imageToTest_padded.shape[1])
#     #net.blobs['image'].reshape(1,3,11,11)
