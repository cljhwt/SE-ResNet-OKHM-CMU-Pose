...
parser.add_argument('--init_model_param',
                    default='/home/data/wangchenliang/pytorch-paf-model/pretrained-MobileNet-all-start/init_model_param.pth',
                    type=str)
...
parser.add_argument('--logdir',
                    default='/home/data/wangchenliang/pytorch-paf-model/pretrained-MobileNet-all-start/tensorboy',
...
parser.add_argument('--gpu_ids', dest='gpu_ids', help='which gpu to use', nargs="+",
                    default=[3, ], type=int)  # nargs="+"表示至少一个
...
# 最终模型保存位置
model_save_filename = '/home/data/wangchenliang/pytorch-paf-model/pretrained-MobileNet-all-start/best_pose-pretrained-MobileNet.pth'
# 前五个epoch产生的模型保存位置
model_save_filename1 = '/home/data/wangchenliang/pytorch-paf-model/pretrained-MobileNet-all-start/best_pose-pretrained-MobileNet-epoch5.pth'
# 模型参数保存位置
model_load_all_para_save_filename = '/home/data/wangchenliang/pytorch-paf-model/pretrained-MobileNet-all-start/model-save-para/model_all_para.pth'
#加载参数模型的位置
model_all_para_save_filename = '/home/data/wangchenliang/pytorch-paf-model/pretrained-MobileNet-all-start/model-save-para/model_all_para.pth'
...
writer.export_scalars_to_json(
    os.path.join('/home/data/wangchenliang/pytorch-paf-model/pretrained-MobileNet-all-start', "all_scalars.json"))
writer.close()
