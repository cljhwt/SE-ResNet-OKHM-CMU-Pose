...
def putVecMaps(centerA, centerB, accumulate_vec_map, count, params_transform):
    ...
    stride = params_transform['stride'] #8
    crop_size_y = params_transform['crop_size_y'] #368
    crop_size_x = params_transform['crop_size_x'] #368
    grid_y = crop_size_y / stride #46
    grid_x = crop_size_x / stride #46
    thre = params_transform['limb_width']   # limb width 1.0
