...
with torch.autograd.no_grad():
    ...
    weight_name = '/home/data/wangchenliang/pytorch-paf-model/pretrained-MobileNet-okhm-kd/best_pose-pretrained-MobileNet-100.pth'
    ...
    run_eval(image_dir='/home/caffe/wangcl/wangcl/openpose/tests_database/val_images', anno_dir='/data/coco', vis_dir='/home/data/wangchenliang/pytorch-paf-model/pretrained-MobileNet-okhm-kd/vis-100',
             image_list_txt='./evaluate/image_info_val2014_1k.txt',
             model=model, preprocess='vgg')
